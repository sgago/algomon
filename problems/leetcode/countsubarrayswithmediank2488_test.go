...
We need to find all subarrays with median k.

Note there's a very small n, suggesting N^2 or N! solution via combinatorial/backtracking/dp.
...
func countSubarraysWithMedianK(nums []int, k int) {
